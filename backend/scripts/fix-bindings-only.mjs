...
const bindingsPath = path.resolve(import.meta.dirname, "../src/modules/chat/chat-pipeline-bindings.ts");
fs.writeFileSync(bindingsPath, `import type { Request, Response } from "express";
